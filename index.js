...
function startGulp(name, opts) {
  ...
  var buildPath = './node_modules/bitcore-build-square/';
  ...
  if (browser) {
    ...
    if (name !== 'lib') {
      browserifyCommand = browserifyPath + ' --require ./index.js:' + fullname + ' --external bitcore-lib-square -o ' + fullname + '.js';
    } else {
      browserifyCommand = browserifyPath + ' --require ./index.js:bitcore-lib-square -o bitcore-lib-square.js';
    }
